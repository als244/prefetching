...
void conv2D(DATA_TYPE* A, DATA_TYPE* B, unsigned int NI, unsigned int NJ)
{
	unsigned int i, j;
...
void init(DATA_TYPE* A, DATA_TYPE* A_gpu, unsigned int NI, unsigned int NJ)
{
	unsigned int i, j;
...
void compareResults(DATA_TYPE* B, DATA_TYPE* B_outputFromGpu, unsigned int NI, unsigned int NJ)
{
...
void convolution2DCuda(DATA_TYPE* A_gpu, DATA_TYPE* B_gpu, unsigned int NI, unsigned int NJ)
{
