...
void conv3D(DATA_TYPE* A, DATA_TYPE* B, unsigned int NI, unsigned int NJ, unsigned int NK)
{
	unsigned int i, j, k;
...
void init(DATA_TYPE* A, DATA_TYPE* A_gpu, unsigned int NI, unsigned int NJ, unsigned int NK)
{
	unsigned int i, j, k;
...
void compareResults(DATA_TYPE* B, DATA_TYPE* B_outputFromGpu, unsigned int NI, unsigned int NJ, unsigned int NK)
{
...
__global__ void convolution3D_kernel(DATA_TYPE *A, DATA_TYPE *B, unsigned int i, unsigned int NI, unsigned int NJ, unsigned int NK)
{
...
void convolution3DCuda(DATA_TYPE* A_gpu, DATA_TYPE* B_gpu, unsigned int NI, unsigned int NJ, unsigned int NK)
{
...
int main(int argc, char *argv[])
{
	...
	unsigned int NI = (unsigned int) atoi(argv[1]);
	unsigned int NJ = (unsigned int) atoi(argv[2]);
	unsigned int NK = (unsigned int) atoi(argv[3]);
